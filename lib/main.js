(function() {
  'use strict';
  var Arity_error, H, Internals, Named_arity_error, Normalize_function_arguments, Not_implemented_error, Positional_arity_error, Value_mismatch_error, bind_instance_methods, debug, get_signature, gnd, help, hide, internals, nameit, nfa, normalizer, rpr, warn;
    ...
    nfa(fn)/* Normalize Function Arguments */ {
      ...
      return function(...P) {
        ...
        if (gnd.pod.isa(P.at(-1))) {
          if (arity === 0) {
            throw new Named_arity_error("Ωnfa___2 expected up to 0 named arguments objects, got 1");
          } else {
