...
/* Harmonize values: */
        ...
        switch (type = type_of(fn)) {
          ...
          default:
            throw new Error(`Ωnfa___7 unable to handle callable of type ${rpr(type)}`);
        }
      });
    }
