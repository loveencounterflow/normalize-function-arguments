(function() {
  'use strict';
  var Argument_type_error, Arity_error, H, Internals, Named_arity_error, Nfa_error, Normalize_function_arguments, Not_implemented_error, Positional_arity_error, Runtime_arity_error, Signature_cfg_position_error, Signature_disposition_Error, Signature_error, Signature_missing_parameter_Error, Signature_naming_Error, Template, Type_error, Value_mismatch_error, bind_instance_methods, debug, get_signature, gnd, help, hide, internals, nameit, nfa, normalizer, push_at, rpr, set_at, warn;
  ...
  // pop_at
  ({Template, gnd, hide, bind_instance_methods, nameit, push_at, set_at, debug, warn, help, rpr} = H);
  ...
  Normalize_function_arguments = class Normalize_function_arguments {
    ...
    nfa(cfg, fn)/* Normalize Function Arguments */ {
      var arity, fn_name, names, q_idx, q_ridx;
